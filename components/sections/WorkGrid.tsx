...
import { ArrowRight, ArrowUpRight, X, Code2, Globe } from "lucide-react";
...
import { PROJECT_THEMES } from "./SelectedWorkSection";
...
export function WorkGrid() {
  ...
  return (
    <section className="w-full py-16 px-6 md:px-12 lg:px-24 select-none">
      <div className="mx-auto w-full max-w-7xl">
        
        {/* Header Section */}
        <div className="mb-14 flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            <span className="font-mono text-xs tracking-widest uppercase text-[var(--primary)] font-medium">
              — ARCHIVE &amp; CASE STUDIES
            </span>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              <h1 className="font-serif text-[3.25rem] sm:text-[4.5rem] lg:text-[5.5rem] text-[var(--on-background)] leading-[0.95] tracking-tight">
                Production Works &amp;<br />
                <span className="italic text-[var(--primary)] font-serif font-light">Architectures</span>
              </h1>
              <span className="font-mono text-xs text-[var(--on-surface-variant)] tracking-widest md:mb-4 uppercase">
                INDEX 2024 — 2026
              </span>
            </div>
          </div>
          ...
          {/* Filter Pills */}
          <div className="flex flex-wrap items-center gap-2 pt-6 border-t border-[var(--outline-variant)]/60">
            {filters.map((filter) => (
              <button
                key={filter}
                type="button"
        ...
        <div className="hidden lg:grid lg:grid-cols-12 gap-10 xl:gap-14 items-start">
          ...
          <div className="lg:col-span-7 xl:col-span-7 sticky top-28">
            <div className="relative">
              ...
              <div className="relative rounded-[22px] overflow-hidden border border-[var(--outline-variant)]/80 bg-[var(--surface-container-low)] shadow-xl">
                <SkiperClipMask id="work-grid-svg-mask" enabled={!shouldReduceMotion} className="w-full">
                  <SkiperParallaxImage
                    src={activeImg}
