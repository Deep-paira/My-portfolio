...
export function CtaSection() {
  ...
  return (
    <section
      id="contact"
      className="relative w-full py-24 lg:py-32 px-6 lg:px-20 bg-transparent border-t border-[var(--outline-variant)]/40 overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-10">
            <div className="flex flex-col gap-6">
              ...
              <h2 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-[var(--on-background)] dark:text-white tracking-tight leading-[1.05] font-normal">
                Let&#39;s build <br />
                something <br />
              ...
              <p className="font-sans text-base sm:text-lg text-[var(--on-surface-variant)] dark:text-neutral-400 leading-relaxed max-w-md">
                ...
                Drop a line or reach out directly.
              </p>
            </div>
          ...
          <div className="lg:col-span-7">
            <form onSubmit={handleSubmit} className="flex flex-col gap-9">
              ...
              <div
                ...
                aria-hidden="true"
              >
                <label htmlFor="hp_cta">Leave empty</label>
                <input
                  type="text"
                  id="hp_cta"
                  name="honeypot"
